...
namespace CatalogueRemake
{
    ...
    public class CatalogueRemakeTests
    {
        ...
        public void SortStudentsAlphabetically()
        {
            ...
            Catalog<Student> catalogue = new Catalog<Student>(new Group<Student> { one, two, three });
            CollectionAssert.AreEqual(new Group<Student> { two, three, one }.ToArray(), catalogue.SortAlphabetically().ToArray());
        }
        [TestMethod]
        public void SortStudentsbyGeneralMeanDescending()
        {
            ...
            Student one = new Student("Chira Iulia", new Discipline[] { new Discipline("Math", new int[] { 7, 10 }), new Discipline("English", new int[] { 9 }), new Discipline("Chemistry", new int[] { 8 }) });
            Catalog<Student> catalogue = new Catalog<Student>(new Group<Student> { one, two, three });
            CollectionAssert.AreEqual(new Group<Student> { three, one, two }.ToArray(), catalogue.SortByGeneralMeanDescending().ToArray());
        }
        [TestMethod]
        public void GetStudentsWithSpecificGeneralMean()
        {
            ...
            Catalog<Student> catalogue = new Catalog<Student>(new Group<Student> { one, two, three });
            CollectionAssert.AreEqual(new Group<Student> { one, three }.ToArray(), catalogue.GetStudentsWithSpecificGeneralMean(9.5).ToArray());
        }
        [TestMethod]
        public void GetStudentsWithGreatestNumberOfTens()
        {
            ...
            Student one = new Student("Chira Iulia", new Discipline[] { new Discipline("Math", new int[] { 9, 10 }), new Discipline("English", new int[] { 9 }), new Discipline("Chemistry", new int[] { 10 }) });
            Catalog<Student> catalogue = new Catalog<Student>(new Group<Student> { one, two, three });
            CollectionAssert.AreEqual(new Group<Student> { one, three }.ToArray(), catalogue.GetStudentsWithGreatestNumberOfASpecificGrade(10).ToArray());
        }
        [TestMethod]
        public void GetStudentsWithLowestGeneralMean()
        {
            ...
            Student one = new Student("Chira Iulia", new Discipline[] { new Discipline("Math", new int[] { 9, 10 }), new Discipline("English", new int[] { 9 }), new Discipline("Chemistry", new int[] { 10 }) });
            Catalog<Student> catalogue = new Catalog<Student>(new Group<Student> { one, two, three });
            CollectionAssert.AreEqual(new Group<Student> { two }.ToArray(), catalogue.GetStudentsWithLowestGeneralMean().ToArray());
        }
    }
}